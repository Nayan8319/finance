...
import { getSales } from '../../../javaScript/functions';
...
export default function Sales() {
    ...
    return (
        <div className="card">
            ...
            <Toolbar className="mb-4" id="toolbar" start={<p className='font-medium text-xl'> Sales Data </p>} end={rightToolbarTemplate}></Toolbar>
            <DataTable ref={dt} value={sales} showGridlines tableStyle={{ minWidth: '50rem' }}
                paginator rows={10} rowsPerPageOptions={[5, 10, 25]}
                paginatorTemplate="FirstPageLink PrevPageLink PageLinks NextPageLink LastPageLink CurrentPageReport RowsPerPageDropdown"
                currentPageReportTemplate="Showing {first} to {last} of {totalRecords} Transactions" 
            >
                <Column sortable field="transaction_id" header="ID"></Column>
                <Column sortable field="customer_name" header="Customer Name"></Column>
