...
function DashCustomer() {
    return (
        <div className="grid grid-cols-1 container mx-auto my-4 px-4">
            <div className="bg-white border shadow rounded-lg mb-4 p-4 sm:p-6 h-full">
                <div className="flex items-center justify-between mb-4">
                    <h3 className="text-xl font-bold leading-none text-gray-900">Latest Customers</h3>
                    <a href="#page" className="text-sm font-medium text-cyan-600 hover:bg-gray-100 rounded-lg inline-flex items-center p-2">
                        View all
                    </a>
                </div>
